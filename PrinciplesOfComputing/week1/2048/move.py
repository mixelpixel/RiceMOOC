...
##            self.new_tile()
    ...
    def move(self, direction):
        ...
        for cell in self._initial_tile_cells[direction]:
            print self.traverse_grid(cell, OFFSETS[direction], distance)
...
##            moved = True
    ...
    def traverse_grid(self, start_cell, direction, num_steps):
        ...
        for step in xrange(num_steps):
            ...
            travel_list.append(self._grid[row][col])
        return travel_list
...
print TEST1.traverse_grid((0,0), OFFSETS[UP], TEST1.get_grid_height())
TEST1.move(LEFT)
