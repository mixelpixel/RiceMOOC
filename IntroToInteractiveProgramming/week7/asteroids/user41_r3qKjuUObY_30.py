...
#            print self.pos, self.vel, self.angle, fwd_dir
...
def rock_spawner():
    global a_rock
    a_rock.pos = [random.randrange(0, 800), random.randrange(0, 600)]
    a_rock.vel = [pos_or_neg(random.randrange(1, 4)), pos_or_neg(random.randrange(0, 3))]
    a_rock.ang = pos_or_neg(random.rand_range(0, 7)
    a_rock.ang_vel = pos_or_neg(random.randrange(1, 15)/100.0)
    a_rock = Sprite(a_rock.pos, a_rock.vel, a_rock.ang, a_rock.ang_vel, asteroid_image, asteroid_info)
...
a_rock = Sprite([random.randrange(0, 800), random.randrange(0, 600)],
                [pos_or_neg(random.randrange(1, 4)), pos_or_neg(random.randrange(0, 3))],
                0, pos_or_neg(random.randrange(1, 15)/100.0),asteroid_image, asteroid_info)
# register handlers
