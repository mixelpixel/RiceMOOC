...
#        if self.shoot:
#            self.age +=1
#            if self.age > missile_info.lifespan:
#                kill_sprite()
...
def key_down(key):
    ...
    if simplegui.KEY_MAP['left'] == key:
        ...
        a_missile.shoot = True
        a_missile.vel = angle_to_vector(a_missile.angle_vel)
        a_missile.vel[0] *= 4
        a_missile.vel[1] *= 4
...
def rock_spawner():
    ...
    vel = [pos_or_neg(random.randrange(1, 4)), pos_or_neg(random.randrange(0, 3))]
    ang  = pos_or_neg(random.randrange(0, 7))
    ang_vel = pos_or_neg(random.randrange(1, 15)/100.0)
...
a_missile = Sprite((my_ship.pos[0] + my_ship.radius + 10, my_ship.pos[1]), my_ship.vel, my_ship.angle, my_ship.angle_vel,
                   missile_image, missile_info, missile_sound)

a_rock = Sprite([random.randrange(40, 760), random.randrange(40, 560)],
