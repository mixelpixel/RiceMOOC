...
def declarations(): #I zipped all this up into a function
...
def draw_lives(x): #This needs improving
    '''this could be better'''
    if lives == 3:
        x.draw_image(my_ship.image, [45, 45], my_ship.image_size, [60, 70], (20, 20), math.pi * 1.5)
        x.draw_image(my_ship.image, [45, 45], my_ship.image_size, [85, 70], (20, 20), math.pi * 1.5)
        x.draw_image(my_ship.image, [45, 45], my_ship.image_size, [110, 70], (20, 20), math.pi * 1.5)
    elif lives == 2:
        x.draw_image(my_ship.image, [45, 45], my_ship.image_size, [60, 70], (20, 20), math.pi * 1.5)
        x.draw_image(my_ship.image, [45, 45], my_ship.image_size, [85, 70], (20, 20), math.pi * 1.5)
    else:
