...
def hit():
    ...
    if in_play:
        ...
        outcome = 'Player ' + str(player_hand) + ' ' + str(score)
        print outcome
    if score > 21:
        in_play = False
        outcome = 'BUST!!!'
...
def stand():
    ...
    global in_play, score #I'M NOT SURE "SCORE" IS PER HAND OR OVERALL GAMES...?
    if not in_play:
        ...
        in_play = False
        score = dealer_hand.get_value()
        outcome = 'Dealer ' + str(dealer_hand) + ' ' + str(score) 
        print outcome
