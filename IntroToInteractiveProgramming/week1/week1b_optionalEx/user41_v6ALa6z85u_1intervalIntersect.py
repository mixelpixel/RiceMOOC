...
def interval_intersect(a,b,c,d):
    """returns True if the intervals [a,b] and [c,d]
    intersect and False otherwise. Assume that a<=b
    and c<=d"""
    return ((a == (c or d)) or (b == (c or d))) or ((a < (c or d)) and (b > (c or d)))
#ALSO
#	((a == (c or d)) or (b == (c or d))) or ((a < (c or d)) and (b > (c or d)))
#ALSO
#	return (c <= b) and (a <= d)
