...
def declare_globals():
    ...
    global missile_group, num_of_missiles, missile_lifespan, msl_thrust, missile_radius, missile_volume
...
#THESE ARE MY IMAGES AND SOUNDS - PLEASE COMMENT OUT IF THEY DON'T LOAD - THANK YOU!!!!
    ...
    explosion_image = simplegui.load_image("https://dl.dropbox.com/s/ot3xxgigueimg9s/explosion_sheet.png")
...
def process_sprite_group(sprite_group, canvas):
    ...
    ### NOTE: ADDING THE AGE=+1 TO DRAW FOR EXPLOSIONS
    ### SLOWED DOWN MISSILE VELOCITY
    ### MAYBE I SHOULD HANDLE THIS ELSEWHERE?
        for missile in list(missile_group):
            missile.age +=1
            if missile.age > missile.lifespan:
                missile_group.remove(missile)
    ### OR SHOULD I HANDLE THE EXPLOSION AGE/REMOVAL HERE????
...
class Sprite:
    ...
    def __init__(self, pos, vel, ang, ang_vel, image, info, sound = None):
        ...
        self.age = 0
        if sound: #ONLY MISSILES HAVE SOUND, BUT WHAT IF I NEEDED EXPLOSIONS TO HAVE A DIFFERENT LEVEL?
            sound.rewind()
            sound.play()
    ...
    def update(self):
        ...
        wrap(self.pos, self.vel)
        if self.animated:
        #AT 90 IT WRAPPED AROUND, BUT WITH THIS INCLUDED I HAD TO UP IT TO 120, WHY??
            self.age +=1 #ADDING THIS HERE AFFECTED THE DURATION OF THE MISSILE FIRE
