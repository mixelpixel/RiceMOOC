...
#- yymmdd@????finished
#---------------------------------------------------------------------72
###CHALLENGE - HOW TO START GAMES WITHOUT THE SHIP?????
...
class Ship:
    ...
    def __init__(self, pos, vel, angle, image, info):
        ...
        self.image = image
        self.image_center = list(info.get_center()) #keeps the lives draw handler able to ref info
...
#    if started:###MAKING THESE RELATIVE TO IF FUCKS THEM ALL UP, WHY??
...
def draw_lives(canvas):
    ...
    like the original Asteroids - NOTE: based on the
    ImageInfo instance, not the Ship instance
    Image center is affected by rocket thrust, so (45, 45)'''
