...
# FOR BETTER OBJECT ORIENTED PROGRAMMING PRACTICE, FIGURE OUT HOW TO EXTRACT "MY_SHIP" CALLS
# BY MAKING A SHIP GROUP?
# RESTATING GAME DOESN't RESET DIFFICULTY LEVEL BASED ON SCORE, WHY????
...
# globals bindings - HMM, SHOULD I CAPITALIZE ALL OF THEM?
def declare_globals():
...
#THESE ARE MY IMAGES AND SOUNDS - PLEASE COMMENT OUT IF THEY DON'T LOAD - THANK YOU!!!!
    ...
    ### MAKE MY OWN EXPLOSION with GIMP thanks to https://gimper.net/resources/sprite-sheet-animation-tiles.633/
...
#    "http://commondatastorage.googleapis.com/codeskulptor-assets/sounddogs/explosion.mp3")
    pass #JUST HERE SO THIS FUNCTION COLLAPSES IN FULL
...
def draw(canvas):
    ...
    if group_collide(rock_group, my_ship):
        lives -=1
        ship_explosion = Sprite(my_ship.pos, my_ship.vel, my_ship.angle, my_ship.angle_vel, explosion_image, explosion_info, explosion_sound)
